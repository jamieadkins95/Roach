...
class CollectionPlaceholderFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as? AppCompatActivity)?.apply {
            ...
            title = getString(R.string.collection_manager)
        }

        toolbar.setTitleTextAppearance(requireContext(), R.style.GwentTextAppearance)

        title?.text = getString(R.string.collection_placeholder_title)
        message?.text = getString(R.string.collection_placeholder_message)
    }
}
