...
class CardDetailsParentFragment : DaggerFragment(), DetailContract.View {
    ...
    companion object {
        ...
        fun withCardId(cardId: String): CardDetailsParentFragment {
            return CardDetailsParentFragment().apply {
